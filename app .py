...
<div style='text-align:center; padding:10px;'>
    <h2 style='color:#FF5A5F !important;'>📱 Navigate</h2>
</div>
""", unsafe_allow_html=True)
...
# ============================================
# PAGE 1 — INTRODUCTION & HOOK
# ============================================
if page == "Introduction & Hook":
 
    st.markdown("""
    <div style='text-align:center; padding:30px 0 10px 0;'>
        <h1 style='font-size:2.8rem; color:#FF5A5F !important;'> Social Media & Student Well-being</h1>
        <h3 style='color:#aaaaaa !important;'>FINAL PROJECT</h3>
        <p style='color:#dddddd !important; font-size:1rem;'>
            VENKATA PUNEETH SRIRAMANENI &nbsp;|&nbsp; Visual Analytics & Comm. DSA506-01-2651
        </p>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div class='interpretation-box'>
        ...
        the impact of social media usage on student mental health. The dataset contains responses from
        <b>481 real students</b> covering numerical, categorical, and text-based data types.
    </div>
    """, unsafe_allow_html=True)
    ...
    hook_data = pd.DataFrame({
        ...
        'Percentage': [
            depressed/total*100, sleep_issues/total*100,
    ...
    st.markdown("""
    <div class='interpretation-box'>
         <b>Interpretation:</b> This section introduces the emotional reality behind social media
        usage among students. Nearly <b>46% of students feel depressed</b> and <b>49% face sleep
        problems</b> — directly linked to excessive social media use. These are not just numbers —
        these are real students struggling every day.
    </div>
    """, unsafe_allow_html=True)
 
 
# ============================================
# PAGE 2 — CONTEXT & CONFLICT
# ============================================
elif page == " Context & Conflict":
 
    st.markdown("""
    <div style='text-align:center; padding:20px 0;'>
        <h1 style='color:#FF5A5F !important;'> Context & Conflict</h1>
        <p style='color:#aaaaaa !important;'>VENKATA PUNEETH SRIRAMANENI | DSA506-01-2651</p>
    </div>
    """, unsafe_allow_html=True)
    st.markdown("<hr style='border:1px solid #333;'>", unsafe_allow_html=True)
    ...
    with col2:
        ...
        fig_time = px.bar(time_data, x='Time_Spent', y='Count',
            color='Count', color_continuous_scale='Oranges',
            title='Daily Social Media Usage', text='Count')
        fig_time.update_traces(textposition='outside')
        fig_time.update_layout(plot_bgcolor='#0d0d0d', paper_bgcolor='#0d0d0d',
    ...
    st.markdown("""
    <div class='interpretation-box'>
        <b>Interpretation:</b> University students make up the largest portion (~60.7%) of
        survey participants. Most students spend between 2-4 hours daily on social media, with
        a significant group using it for more than 5 hours. Female participants represent ~54.7%
        of respondents, while male participants account for ~43.9%.
    </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("""
    <div class='interpretation-box'>
         <b>Interpretation:</b> The graphs reveal a clear upward trend between daily social media
        usage and average depression scores. Students spending less than one hour report the lowest
        depression scores (~2.0), while those using it for more than 5 hours show the highest scores
        (~3.5+). The same pattern holds for sleep issues — more screen time directly leads to
        worse sleep quality.
    </div>
    """, unsafe_allow_html=True)
...
# ============================================
    ...
    st.markdown("""
    <div style='text-align:center; padding:20px 0;'>
        <h1 style='color:#FF5A5F !important;'>🔍 Journey & Analysis</h1>
        <p style='color:#aaaaaa !important;'>VENKATA PUNEETH SRIRAMANENI | DSA506-01-2651</p>
    </div>
    """, unsafe_allow_html=True)
    st.markdown("<hr style='border:1px solid #333;'>", unsafe_allow_html=True)
    ...
    st.markdown("""
    <div class='interpretation-box'>
         <b>Interpretation:</b> Instagram, YouTube, Facebook, and TikTok are the most commonly
        used platforms among students. These platforms are known for highly engaging, addictive
        content that keeps users scrolling for hours — directly contributing to mental health issues.
    </div>
    """, unsafe_allow_html=True)
    ...
    with col1:
        st.markdown("##  Comparison Sentiment")
        ...
        st.markdown("""
        <div class='interpretation-box'>
             Around 35% of students reported negative feelings when comparing themselves
            to others on social media — feeling emotionally uncomfortable after scrolling.
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        ...
        if len(gender_main) > 0:
            ...
            fig_ganim.update_layout(plot_bgcolor='#0d0d0d', paper_bgcolor='#0d0d0d',
                font_color='white', title_x=0.5, showlegend=False,
                yaxis=dict(title='Average Score (1-5)', gridcolor='#333'), title_font_size=14)
            st.plotly_chart(fig_ganim, use_container_width=True)
        st.markdown("""
        <div class='interpretation-box'>
             Female participants reported slightly higher levels of depression and worry
            compared to male participants. Non-binary students (gender-neutral individuals)
            showed the highest depression scores.
        </div>
        """, unsafe_allow_html=True)
    ...
    <div class='interpretation-box'>
        ...
        connected. The strongest relationship appears between worry and depression scores. Depression
        and sleep issues also show a strong positive correlation — students who are depressed
        consistently face worse sleep quality.
    </div>
    """, unsafe_allow_html=True)
...
# ============================================
elif page == " Resolution & Action":
 
    st.markdown("""
    <div style='text-align:center; padding:20px 0;'>
        <h1 style='color:#FF5A5F !important;'> Resolution & Call to Action</h1>
        <p style='color:#aaaaaa !important;'>VENKATA PUNEETH SRIRAMANENI | DSA506-01-2651</p>
    </div>
    """, unsafe_allow_html=True)
    st.markdown("<hr style='border:1px solid #333;'>", unsafe_allow_html=True)
 
    st.markdown("##  Which Platforms Cause Most Depression?")
    platform_list = []
    ...
    if platform_list:
        ...
        fig_plat = px.bar(platform_summary, x='Platform', y='Avg_Depression',
            color='Avg_Depression', color_continuous_scale='Reds',
            title='💡 Platform vs Average Depression Score',
    ...
    st.markdown("""
    <div class='interpretation-box'>
         <b>Interpretation:</b> TikTok and Snapchat show the highest average depression scores.
        Platforms built around short-form, comparison-heavy content are more harmful to student
        mental health than informational platforms like YouTube.
    </div>
    """, unsafe_allow_html=True)
 
    st.markdown("<hr style='border:1px solid #333;'>", unsafe_allow_html=True)
    st.markdown("##  Age vs Mental Health (Animated Scatter)")
    ...
    fig_age.update_layout(plot_bgcolor='#0d0d0d', paper_bgcolor='#0d0d0d',
        font_color='white', title_x=0.5, legend=dict(bgcolor='#1a1a1a'))
    st.plotly_chart(fig_age, use_container_width=True)
 
    st.markdown("""
    <div class='interpretation-box'>
         <b>Interpretation:</b> Students with higher depression scores also tend to report more
        sleep-related problems. Larger bubble sizes indicate higher worry levels — emotional stress
        increases alongside depression and sleep issues across different age groups.
    </div>
    """, unsafe_allow_html=True)
 
    st.markdown("<hr style='border:1px solid #333;'>", unsafe_allow_html=True)
    st.markdown("##  Call to Action (Animated)")
    ...
    fig_cta.update_layout(plot_bgcolor='#0d0d0d', paper_bgcolor='#0d0d0d',
        font_color='white', title_x=0.5, showlegend=False,
    ...
    st.markdown("""
    <div class='interpretation-box'>
         <b>Interpretation:</b> Limiting daily social media usage to less than two hours could
        have the strongest positive impact on student mental health. Awareness campaigns score
        highest on feasibility — easiest to implement immediately.
    </div>
    """, unsafe_allow_html=True)
    ...
    fig_em.update_layout(plot_bgcolor='#0d0d0d', paper_bgcolor='#0d0d0d',
        font_color='white', title_font_size=18, title_x=0.5, showlegend=False,
    ...
    st.markdown("""
    <div class='interpretation-box'>
        This project explored the impact of social media usage on student mental health using
        numerical, categorical, and text-based analysis. The findings revealed strong relationships
        between excessive screen time and increased levels of depression, worry, sleep issues,
        distraction, and unhealthy online comparison behaviors.<br><br>
        Students spending more than 5 hours daily consistently showed the highest mental health
        risk scores. TikTok and Snapchat were linked to the highest depression scores. The data
        strongly suggests that <b>limiting screen time, implementing school mental health programs,
        and increasing awareness</b> are the most impactful solutions.<br><br>
    ...
    <div style='text-align:center; padding:25px; background:linear-gradient(135deg,#1a1a2e,#16213e);
        ...
        <p style='color:#aaaaaa !important; font-size:1rem;'>
            ...
            <b style='color:white;'>VENKATA PUNEETH SRIRAMANENI</b><br>
